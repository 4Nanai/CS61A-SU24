...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not current_place.is_hive:
            if current_range >= self.lower_bound and current_range <= self.upper_bound:
