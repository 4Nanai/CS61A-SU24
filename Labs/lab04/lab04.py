...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    # Old one
    # new_tree = t
    # def replace_helper(tr, replacement):
    #   if is_leaf(tr) is True:
    #       if label(tr) == "loki":
    #         tr[0] = lokis_replacement
    #   else:
    #       for b in branches(tr):
    #           replace_helper(b, replacement)
    # replace_helper(new_tree, lokis_replacement)
    # return new_tree


    # Contruct the whole new tree

    if is_leaf(t) is True and label(t) == "loki":
